...
void update_colours() {
  ...
  if (in_night_range()) {
    ...
    text_layer_set_text_color(time_layer, GColorFromHEX(time_text_colour));
    text_layer_set_text_color(date_layer, GColorFromHEX(date_text_colour));
    text_layer_set_text_color(temperature_layer, GColorFromHEX(temperature_text_colour));
    text_layer_set_text_color(conditions_layer, GColorFromHEX(condition_text_colour));
    ...
    text_layer_set_background_color(background_layer, GColorFromHEX(date_text_colour));
